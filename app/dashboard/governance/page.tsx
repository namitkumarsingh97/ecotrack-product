...
export default function GovernancePage() {
  ...
  const metrics = selectedCompanyId
    ? governanceMetricsMap[selectedCompanyId] || []
    : [];
  ...
  const tableColumns = [
    ...
    {
      label: t("governance.boardMembers"),
      field: "boardMembers",
      sortable: true,
    },
    {
      label: t("governance.independentDirectors"),
      field: "independentDirectors",
      sortable: true,
    },
    {
    ...
    {
      label: t("governance.complianceViolations"),
      field: "complianceViolations",
      sortable: true,
    },
    {
  ...
  const tableRows = filteredMetrics.map((metric) => ({
    ...
    boardMembers:
      metric.boardMembers != null ? metric.boardMembers.toLocaleString() : "0",
